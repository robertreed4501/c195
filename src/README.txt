...
the number of appointments by type and month, and each contact's next months' schedule.
...
completely and press 'Save' to save the new record.  Pressing the exit button will, you guessed it, exit the application.
